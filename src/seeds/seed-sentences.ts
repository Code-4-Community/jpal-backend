    ...
    await connection
      ...
      .values([
        // Overall rating sentence
        {
          ...
          includeIfSelectedOptions: ['Very poor', 'Poor', 'Neutral', 'Good', 'Very good', 'Excellent', 'Exceptional'],
        ...
        // Communication sentence
        {
          ...
          isPlainText: false,
          isMultiQuestion: false,
          includeIfSelectedOptions: ['Somewhat effective', 'Effective', 'Very effective', 'Incredibly effective'],
        ...
        {
          template: 'Given enough resources, I would {recommendation} {subject} as a regular employee.',
          isPlainText: false,
          isMultiQuestion: false,
