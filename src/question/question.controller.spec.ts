...
import { exampleOptions, FIVE_SENTIMENT_OPTIONS, NEVER, RARELY, OFTEN, ALWAYS } from './question.examples';
...
const questionInfo: questionDTO[] = [
  question1, question2
]
...
const multiquestion1: multiQuestionDTO = {
  sentence_template: "Youth was a ___, ___, and ___ employee",
  fragment_texts: ["responsible", "timely", "hard-working"],
  question_texts: ["was youth a responsible employee?", "was youth a timely employee?", "was youth a hard-working employee?"],
  options: [
    ["yes", "no"],
    ["yes", "no"],
    ["yes", "no"]
...
const multiQuestionInfo: multiQuestionDTO[] = [
  multiquestion1
]
...
describe('QuestionController', () => {
  ...
  describe('create questions', () => {
    it('should return number of sentences and questions made', async () => {
      expect(await controller.create(mockUploadQuestionDTO)).toEqual([
        mockUploadQuestionResponseDTO
      ]);
