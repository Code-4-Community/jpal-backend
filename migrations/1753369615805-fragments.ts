...
export class fragments1753369615805 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "fragment" ("id" SERIAL NOT NULL, "text" character varying NOT NULL, "includeIfSelectedOptions" text[] NOT NULL DEFAULT '{}', "questionId" INTEGER UNIQUE, "sentenceId" INTEGER UNIQUE, CONSTRAINT "PK_fragment_id" PRIMARY KEY ("id"))`,
    );
