...
export class addSurveyModel1633284940968 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "assignment" DROP CONSTRAINT "FK_9ebd630ebe2cda5dd203c74b851"`);
        await queryRunner.query(`ALTER TABLE "assignment" DROP CONSTRAINT "FK_05a3e7f4dee38025bf6f219c4ec"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "assignment" ADD CONSTRAINT "FK_05a3e7f4dee38025bf6f219c4ec" FOREIGN KEY ("creatorId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "assignment" ADD CONSTRAINT "FK_9ebd630ebe2cda5dd203c74b851" FOREIGN KEY ("surveyTemplateId") REFERENCES "survey_template"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
